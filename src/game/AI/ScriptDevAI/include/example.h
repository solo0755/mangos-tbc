...
const initClazz all[] = {
	...
	{ CLASS_WARLOCK,u8"学习 |cff6247c8召唤小鬼|h|r 职业技能",{ 688, 712,691,697 },{} ,{ u8"痛苦",u8"恶魔学识",u8"毁灭" } },
	{ 0, u8"未定义",{},{} ,{ u8"",u8"",u8"" } },
	{ CLASS_DRUID,u8"学习 |cff6247c8熊形态和飞行形态|h|r 职业技能",{ 5487,9634,6795,6807,33943,40120 },{} ,{ u8"平衡",u8"野性战斗",u8"恢复" } }
};
static const uint32 SWBossIndex[6][5] = { { 5800061,5800064,5800246,5800244},{ 5800062 },{ 0 },{ 5800346,5800347},{ 5800348,5800162 },{ 0,0 }  };
